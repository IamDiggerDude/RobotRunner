...
public class LoadoutState : AState
{
	...
	[Header("Other Data")]
	public MyLeaderboards leaderboard;
    ...
    //void OnGetCheckLives(GetPlayerStatisticsResult result)
    //{
    ...
    //        {
    //            case "Time":
    //                checkCountTime = Convert.ToDateTime(eachStat.Value);
    //                var requestTime = new GetTimeRequest { };
    //                PlayFabClientAPI.GetTime(requestTime, OnGetTime =>
    //                { checkServerTime = OnGetTime.Time; }, elol => { });
    //                add1 = checkCountTime.AddHours(18);
    //                add2 = checkCountTime.AddHours(12);
    //                add3 = checkCountTime.AddHours(6);
    //                break;

    //            case "Lives":
    //                checkServerHearts = eachStat.Value;
    //                {
    //                    switch (checkServerHearts)
    //                    {
    //                        case 0:


    //                            if (checkServerTime > add1)
    //                            {
    //                                PlayFabClientAPI.ExecuteCloudScript(new ExecuteCloudScriptRequest()
    //                                {
    //                                    FunctionName = "UpdateLives", // Arbitrary function name (must exist in your uploaded cloud.js file)
    //                                    FunctionParameter = new { LivesValue = checkServerHearts + 3 }, // The parameter provided to your function
    //                                    GeneratePlayStreamEvent = true, // Optional - Shows this event in PlayStream
    //                                }, nolol => { }, noelol => { });
    //                            }
    //                            else if (checkServerTime > add2)
    //                            {
    //                                PlayFabClientAPI.ExecuteCloudScript(new ExecuteCloudScriptRequest()
    //                                {
    //                                    FunctionName = "UpdateLives", // Arbitrary function name (must exist in your uploaded cloud.js file)
    //                                    FunctionParameter = new { LivesValue = checkServerHearts + 2 }, // The parameter provided to your function
    //                                    GeneratePlayStreamEvent = true, // Optional - Shows this event in PlayStream
    //                                }, nolol => { }, noelol => { });
    //                            }
    //                            else if (checkServerTime > add3)
    //                            {
    //                                PlayFabClientAPI.ExecuteCloudScript(new ExecuteCloudScriptRequest()
    //                                {
    //                                    FunctionName = "UpdateLives", // Arbitrary function name (must exist in your uploaded cloud.js file)
    //                                    FunctionParameter = new { LivesValue = checkServerHearts + 1 }, // The parameter provided to your function
    //                                    GeneratePlayStreamEvent = true, // Optional - Shows this event in PlayStream
    //                                }, nolol => { }, noelol => { });
    //                            }
